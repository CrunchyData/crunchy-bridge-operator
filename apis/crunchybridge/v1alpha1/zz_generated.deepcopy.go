...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BridgeTeam) DeepCopyInto(out *BridgeTeam) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BridgeTeam.
func (in *BridgeTeam) DeepCopy() *BridgeTeam {
	if in == nil {
		return nil
	}
	out := new(BridgeTeam)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *BridgeTeam) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BridgeTeamList) DeepCopyInto(out *BridgeTeamList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]BridgeTeam, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BridgeTeamList.
func (in *BridgeTeamList) DeepCopy() *BridgeTeamList {
	if in == nil {
		return nil
	}
	out := new(BridgeTeamList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *BridgeTeamList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BridgeTeamSpec) DeepCopyInto(out *BridgeTeamSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BridgeTeamSpec.
func (in *BridgeTeamSpec) DeepCopy() *BridgeTeamSpec {
	if in == nil {
		return nil
	}
	out := new(BridgeTeamSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BridgeTeamStatus) DeepCopyInto(out *BridgeTeamStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BridgeTeamStatus.
func (in *BridgeTeamStatus) DeepCopy() *BridgeTeamStatus {
	if in == nil {
		return nil
	}
	out := new(BridgeTeamStatus)
	in.DeepCopyInto(out)
	return out
}
